...
function createEnemy () {
    mySprite2 = sprites.create(img`
        ...
        . . . c c c c c c c c b b . . . 
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(mySprite2, sprites.dungeon.buttonOrangeDepressed)
}
controller.right.onEvent(ControllerButtonEvent.Pressed, function () {
    if (facingLeft == 1) {
        animation.runImageAnimation(
        mySprite,
        assets.animation`playerRight`,
        300,
        true
        )
        facingLeft = 0
...
function titlePlay () {
    music.playMelody("C5 G B A F A C5 B ", 350)
    game.splash("Welcome to Not PacMan!")
